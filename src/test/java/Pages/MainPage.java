...
public class MainPage<htmlReporter> {
    ...
    //below three variables to store customer details
    ...
    //variable to keep track of transactions made by users
    ...
    //function to read customer details from excel file
    public void readCustomerDetails() throws IOException {

        //giving path of Excel file
        ...
        //the customer postcode value which we get from excel is of type double
        //so converting it into int first to remove the decimal part at the end
        int value = (int) customerPostCodevalue;

        //converting the customer post code value into string
    ...
    public void addCustomerDetails() throws InterruptedException {
        ...
        try {
            ...
            //entering the customer details into respective input boxes
